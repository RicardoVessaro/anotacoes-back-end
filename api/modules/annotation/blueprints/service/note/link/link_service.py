...
from api.modules.annotation.blueprints.data.dao.link_dao import LinkDAO
from api.modules.annotation.blueprints.data.model.link import Link
from api.modules.annotation.blueprints.service.note.link.link_validator import LinkValidator
