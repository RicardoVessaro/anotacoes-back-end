...
from api.modules.annotation.blueprints.view.note_view import NoteView
...
from api.modules.annotation.blueprints.view.mood_view import MoodView, mood_view_name
from api.modules.annotation.blueprints.data.model.mood import Mood
from api.modules.annotation.blueprints.data.dao.mood_dao import MoodDao
